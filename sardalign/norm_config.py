...
basic_punc = period + question_mark + comma + colon + exclamation_mark + left_curly_bracket + right_curly_bracket
...
mapping_quotes = "[" + high_single_quotes + right_single_quotation_mark + left_single_quotation_mark + "]"
